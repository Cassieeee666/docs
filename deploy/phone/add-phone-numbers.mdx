...
<Note>
  At this time, Solvea does **not** support connecting phone numbers from other carriers such as AT&T, Verizon, or T-Mobile.

  Support for additional carriers is under development — please stay tuned for updates.
</Note>
