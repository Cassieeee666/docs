...
The information will be presented to users in a **logistics inquiry card**.
...
```
Use all of the tracking numbers to call logistics_inquiry_tool, to get the latest status. 
```