...
## Option 3: Import Another Phone Number (SIP)

You can also link other phone numbers using **SIP**.

**Steps:**

<Steps>
  <Step>
    Click **Add Phone Number → SIP**.
  </Step>
  <Step>
    Follow the on-screen instructions to complete the SIP configuration.
  </Step>
</Steps>