...
When an agent performs tasks or uses skills, it retrieves information from the Knowledge Base to generate accurate and context-aware responses.

In this section, you will learn:

<Columns cols={1}>
  <Card title="How to add knowledge" icon="circle-plus">
