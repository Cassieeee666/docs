...
**___For example, a Retail Customer Specialist Agent  can manage common e-commerce inquiries such as product recommendations, order tracking, and product usage questions.___**
...
<Frame>
  ![Agentworkflow](/images/agentworkflow.png)
</Frame>
